...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('scanning_document', 'affiliation',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.Affiliation'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Document.affiliation'
        db.delete_column('scanning_document', 'affiliation_id')
