...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Letter.org'
        db.add_column('correspondence_letter', 'org', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.Organization'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Letter.org'
        db.delete_column('correspondence_letter', 'org_id')
    ...
    models = {
        ...
        'correspondence.letter': {
            ...
            'org': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['profiles.Organization']", 'null': 'True', 'blank': 'True'}),
