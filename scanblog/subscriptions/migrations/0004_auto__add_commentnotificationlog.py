...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CommentNotificationLog'
        db.create_table('subscriptions_commentnotificationlog', (
        ...
        db.send_create_signal('subscriptions', ['CommentNotificationLog'])


    def backwards(self, orm):
        # Deleting model 'CommentNotificationLog'
        db.delete_table('subscriptions_commentnotificationlog')
    ...
    models = {
        ...
        'subscriptions.commentnotificationlog': {
