...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserNotificationLog'
        db.create_table(u'subscriptions_usernotificationlog', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('recipient', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'subscriptions', ['UserNotificationLog'])


    def backwards(self, orm):
        # Deleting model 'UserNotificationLog'
        db.delete_table(u'subscriptions_usernotificationlog')
    ...
    models = {
        ...
        u'subscriptions.usernotificationlog': {
            'Meta': {'object_name': 'UserNotificationLog'},
