...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Subscription.campaign'
        db.add_column('subscriptions_subscription', 'campaign',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='organization_subscriptions', null=True, to=orm['campaigns.Campaign']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Subscription.campaign'
        db.delete_column('subscriptions_subscription', 'campaign_id')
    ...
    models = {
        ...
        'subscriptions.subscription': {
            ...
            'campaign': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'organization_subscriptions'", 'null': 'True', 'to': "orm['campaigns.Campaign']"}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'organization': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'organization_subscriptions'", 'null': 'True', 'to': "orm['profiles.Organization']"}),
