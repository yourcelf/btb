...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Note.handle'
        db.delete_column('annotations_note', 'handle')

        # Deleting field 'Note.assigned'
        db.delete_column('annotations_note', 'assigned_id')


    def backwards(self, orm):
        
        # Adding field 'Note.handle'
        db.add_column('annotations_note', 'handle', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True, db_index=True), keep_default=False)

        # Adding field 'Note.assigned'
        db.add_column('annotations_note', 'assigned', self.gf('django.db.models.fields.related.ForeignKey')(related_name='assigned_tickets', null=True, to=orm['auth.User'], blank=True), keep_default=False)
