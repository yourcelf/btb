...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Tag.post_count'
        db.add_column('annotations_tag', 'post_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding unique constraint on 'Tag', fields ['name']
        db.create_unique('annotations_tag', ['name'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Tag', fields ['name']
        db.delete_unique('annotations_tag', ['name'])

        # Deleting field 'Tag.post_count'
        db.delete_column('annotations_tag', 'post_count')
