...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('annotations_note', 'content_type_id')

        # Deleting field 'Note.object_id'
        db.delete_column('annotations_note', 'object_id')


    def backwards(self, orm):
        
        # Adding field 'Note.content_type'
        db.add_column('annotations_note', 'content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True, blank=True), keep_default=False)

        # Adding field 'Note.object_id'
        db.add_column('annotations_note', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True), keep_default=False)
