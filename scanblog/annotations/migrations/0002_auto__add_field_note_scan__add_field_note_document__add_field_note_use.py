...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Note.scan'
        db.add_column('annotations_note', 'scan', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='notes', null=True, to=orm['scanning.Scan']), keep_default=False)

        # Adding field 'Note.document'
        db.add_column('annotations_note', 'document', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='notes', null=True, to=orm['scanning.Document']), keep_default=False)

        # Adding field 'Note.user'
        db.add_column('annotations_note', 'user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='notes', null=True, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Note.scan'
        db.delete_column('annotations_note', 'scan_id')

        # Deleting field 'Note.document'
        db.delete_column('annotations_note', 'document_id')

        # Deleting field 'Note.user'
        db.delete_column('annotations_note', 'user_id')


    models = {
        'annotations.note': {
            'Meta': {'ordering': "['-important', '-created']", 'object_name': 'Note'},
            'assigned': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'assigned_tickets'", 'null': 'True', 'to': "orm['auth.User']"}),
            ...
            'handle': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'db_index': 'True', 'blank': 'True'}),
