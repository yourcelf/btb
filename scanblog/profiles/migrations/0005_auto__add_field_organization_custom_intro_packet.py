...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Organization.custom_intro_packet'
        db.add_column('profiles_organization', 'custom_intro_packet', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Organization.custom_intro_packet'
        db.delete_column('profiles_organization', 'custom_intro_packet')
