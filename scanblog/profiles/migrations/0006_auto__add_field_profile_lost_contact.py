...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.lost_contact'
        db.add_column('profiles_profile', 'lost_contact',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.lost_contact'
        db.delete_column('profiles_profile', 'lost_contact')
