...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.managed'
        db.add_column('profiles_profile', 'managed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Profile.managed'
        db.delete_column('profiles_profile', 'managed')
