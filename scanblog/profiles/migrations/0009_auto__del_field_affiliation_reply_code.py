...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Affiliation.reply_code'
        db.delete_column('profiles_affiliation', 'reply_code_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Affiliation.reply_code'
        raise RuntimeError("Cannot reverse this migration. 'Affiliation.reply_code' and its values cannot be restored.")
