...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Profile.in_prison'
        db.delete_column('profiles_profile', 'in_prison')


    def backwards(self, orm):
        
        # Adding field 'Profile.in_prison'
        db.add_column('profiles_profile', 'in_prison', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
