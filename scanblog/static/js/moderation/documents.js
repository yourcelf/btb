...
(function() {
  ...
  btb.DocumentList = (function(_super) {
    ...
    function DocumentList() {
      return DocumentList.__super__.constructor.apply(this, arguments);
    }
  ...
  btb.EditDocumentManager = (function(_super) {
    ...
    function EditDocumentManager() {
      ...
      return EditDocumentManager.__super__.constructor.apply(this, arguments);
    }
  ...
  btb.EditDocumentView = (function(_super) {
    ...
    function EditDocumentView() {
      ...
      this.render = __bind(this.render, this);
      return EditDocumentView.__super__.constructor.apply(this, arguments);
    }
    ...
    EditDocumentView.prototype.render = function() {
      ...
      _fn = function(page) {
        ...
        pv.bind("highlightChanged", function(crop) {
          var view, _j, _len1, _ref1, _results;
          if (crop) {
            ht = {
              crop: crop,
    ...
    EditDocumentView.prototype.save = function() {
      var d, error, errors, _i, _len, _ref, _ref1,
        _this = this;
      errors = [];
      $(".post-save-message", this.el).html("");
      if (this.doc.get("type") === "post" && !((_ref = this.doc.get("highlight_transform")) != null ? (_ref1 = _ref.crop) != null ? _ref1.length : void 0 : void 0) > 0) {
    ...
    EditDocumentView.prototype.swapPages = function(from, to) {
      var dest, el, frompage, holder, holders, i, offset, offsets, p, p2, page, pages, topage, _i, _j, _len, _ref, _ref1, _ref2, _ref3, _results,
        _this = this;
      ...
      for (i = _i = 0, _ref1 = pages.length; 0 <= _ref1 ? _i < _ref1 : _i > _ref1; i = 0 <= _ref1 ? ++_i : --_i) {
        offset = offsets[i];
        page = pages[i];
        el = $(page.el);
      ...
      page = pages[0];
      dest = holders[1];
      _ref2 = [[pages[0], holders[1]], [pages[1], holders[0]]];
      _results = [];
      for (_j = 0, _len = _ref2.length; _j < _len; _j++) {
        _ref3 = _ref2[_j], page = _ref3[0], dest = _ref3[1];
    ...
    EditDocumentView.prototype.setPageSize = function(size, event) {
      var name, pv, val, _i, _len, _ref, _ref1, _results;
      if (size) {
  ...
  btb.EditDocumentPageView = (function(_super) {
    ...
    EditDocumentPageView.prototype.renderCanvas = function() {
      var c, corners, ctx, h, height, maxx, maxy, minx, miny, scale, theta, tx, ty, w, width, x, y, _i, _len, _ref, _ref1, _ref2, _ref3, _ref4;
      theta = (((_ref = this.page.transformations) != null ? _ref.rotate : void 0) || 0) / 360 * 2 * Math.PI;
      _ref1 = this.page.scan_page.image_dims, w = _ref1[0], h = _ref1[1];
      ...
      _ref2 = [-minx, -miny], tx = _ref2[0], ty = _ref2[1];
      _ref3 = [tx * Math.cos(theta) + ty * Math.sin(theta), ty * Math.cos(theta) - tx * Math.sin(theta)], tx = _ref3[0], ty = _ref3[1];
      scale = Math.min(1, 850 / (maxx - minx));
      _ref4 = [(maxx - minx) * scale, (maxy - miny) * scale], width = _ref4[0], height = _ref4[1];
      $(this.canvas).css({
    ...
    EditDocumentPageView.prototype.highlightRelativeToCrop = function() {
      var cx, cx1, cy, cy1, hx, hx1, hy, hy1, _ref, _ref1, _ref2, _ref3;
      if (!((_ref = this.page.transformations) != null ? (_ref1 = _ref.crop) != null ? _ref1.length : void 0 : void 0) > 0) {
        return this.highlight;
      }
      _ref2 = this.page.transformations.crop, cx = _ref2[0], cy = _ref2[1], cx1 = _ref2[2], cy1 = _ref2[3];
      _ref3 = this.highlight, hx = _ref3[0], hy = _ref3[1], hx1 = _ref3[2], hy1 = _ref3[3];
  ...
  Cropper = (function() {
    ...
    Cropper.prototype.handleMouse = function(mx, my, type, crop) {
      var cursor, d, directions, dx, dy, m, ox, ox1, oy, oy1, x, x1, y, y1, _ref, _ref1;
      directions = "";
      cursor = "";
      if (crop) {
        m = this.grabMargin * 2;
      ...
      if (type === "down") {
        ...
        if ("+" === this.mouseDownState.directions) {
          _ref1 = this.mouseDownState.crop, ox = _ref1[0], oy = _ref1[1], ox1 = _ref1[2], oy1 = _ref1[3];
