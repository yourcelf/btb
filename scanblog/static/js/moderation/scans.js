...
(function() {
  ...
  btb.ScanList = (function(_super) {
    ...
    function ScanList() {
      return ScanList.__super__.constructor.apply(this, arguments);
    }
  ...
  btb.ScanSplit = (function(_super) {
    ...
    function ScanSplit() {
      return ScanSplit.__super__.constructor.apply(this, arguments);
    }
  ...
  btb.ProcessingManager = (function(_super) {
    ...
    function ProcessingManager() {
      ...
      return ProcessingManager.__super__.constructor.apply(this, arguments);
    }
  ...
  btb.ProcessItemListView = (function(_super) {
    ...
    function ProcessItemListView() {
      ...
      return ProcessItemListView.__super__.constructor.apply(this, arguments);
    }
  ...
  btb.ProcessDocListView = (function(_super) {
    ...
    function ProcessDocListView() {
      this.renderDetails = __bind(this.renderDetails, this);
      return ProcessDocListView.__super__.constructor.apply(this, arguments);
    }
  ...
  btb.ProcessScanListView = (function(_super) {
    ...
    function ProcessScanListView() {
      return ProcessScanListView.__super__.constructor.apply(this, arguments);
    }
  ...
  btb.SplitScanView = (function(_super) {
    ...
    function SplitScanView() {
      ...
      return SplitScanView.__super__.constructor.apply(this, arguments);
    }
    ...
    SplitScanView.prototype.checkFinished = function() {
      var assigned, choice, color, colors, finished, id, type, typeMod, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _ref, _ref1, _ref2, _ref3;
      ...
      _ref2 = this.ignoreChoice.get("pages") || [];
      for (_l = 0, _len3 = _ref2.length; _l < _len3; _l++) {
        id = _ref2[_l];
        colors[id] = [this.typeColors.ignore[0]];
      }
      for (_m = 0, _len4 = assigned.length; _m < _len4; _m++) {
        id = assigned[_m];
        btb.colorStripes.apply(btb, ["#status" + id + " .overlay"].concat(__slice.call(colors[id])));
      }
      finished = this.getUnassignedIds().length === 0 && (((_ref3 = this.split.get("scan").author) != null ? _ref3.id : void 0) != null);
    ...
    SplitScanView.prototype.buildScroller = function() {
      var aspect, best, height, n, numCols, numRows, pageHeight, pageWidth, perCol, perRow, waste, wastedSpace, width, _i, _j;
      ...
      for (numRows = _i = 1; 1 <= n ? _i <= n : _i >= n; numRows = 1 <= n ? ++_i : --_i) {
      ...
      for (numCols = _j = 1; 1 <= n ? _j <= n : _j >= n; numCols = 1 <= n ? ++_j : --_j) {
      ...
      if (value) {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          ...
          _results.push((function() {
            ...
            _ref1 = this.choiceViews;
            _results1 = [];
            for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
              view = _ref1[_j];
              _results1.push(view.toggleChoice(false, true));
            }
            return _results1;
          }).call(this));
        }
    ...
    SplitScanView.prototype.setPageScale = function(newScale) {
      var el, h, name, page, scale, w, _i, _len, _ref, _ref1;
      ...
      _ref1 = this.split.get("scan").pages;
  ...
  btb.SplitScanPageDocChoice = (function(_super) {
    ...
    function SplitScanPageDocChoice() {
      ...
      this.render = __bind(this.render, this);
      return SplitScanPageDocChoice.__super__.constructor.apply(this, arguments);
    }
