...
(function() {
  ...
  btb.colorStripes = function() {
    var colors, compats, func, i, oldWebkitArgs, oldWebkitStops, percent, selector, standardArgs, standardStops, _i, _j, _len, _ref, _results;
    selector = arguments[0], colors = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
    percent = 100.0 / colors.length;
    standardStops = [];
    oldWebkitStops = [];
    for (i = _i = 0, _ref = colors.length; 0 <= _ref ? _i < _ref : _i > _ref; i = 0 <= _ref ? ++_i : --_i) {
    ...
    _results = [];
    for (_j = 0, _len = compats.length; _j < _len; _j++) {
      func = compats[_j];
  ...
  btb.FilteredPaginatedCollection = (function(_super) {
    ...
    function FilteredPaginatedCollection() {
      ...
      return FilteredPaginatedCollection.__super__.constructor.apply(this, arguments);
    }
  ...
  btb.PaginatedView = (function(_super) {
    ...
    PaginatedView.prototype.renderPagination = function(collection, el) {
      var i, links, p, _i, _ref;
      p = collection.pagination;
      links = [];
      for (i = _i = 1, _ref = p.pages; 1 <= _ref ? _i <= _ref : _i >= _ref; i = 1 <= _ref ? ++_i : --_i) {
  ...
  btb.TabularList = (function(_super) {
    ...
    function TabularList() {
      ...
      return TabularList.__super__.constructor.apply(this, arguments);
    }
  ...
  btb.LiveCheckbox = (function(_super) {
    ...
    function LiveCheckbox() {
      ...
      this.render = __bind(this.render, this);
      return LiveCheckbox.__super__.constructor.apply(this, arguments);
    }
  ...
  btb.EditInPlace = (function(_super) {
    ...
    function EditInPlace() {
      ...
      this.render = __bind(this.render, this);
      return EditInPlace.__super__.constructor.apply(this, arguments);
    }
