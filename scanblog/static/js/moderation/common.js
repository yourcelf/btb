(function() {
  ...
  btb.FilteredPaginatedCollection = (function() {
    __extends(FilteredPaginatedCollection, Backbone.Collection);
  ...
  btb.PaginatedView = (function() {
    __extends(PaginatedView, Backbone.View);
    ...
    PaginatedView.prototype.renderPagination = function(collection, el) {
      ...
      for (i = 1, _ref = p.pages; 1 <= _ref ? i <= _ref : i >= _ref; 1 <= _ref ? i++ : i--) {
        if (i < 10 || Math.abs(p.page - i) < 5 || i > p.pages - 10) {
          links.push(i);
        }
      }
  ...
  btb.TabularList = (function() {
    __extends(TabularList, btb.PaginatedView);
  ...
  btb.LiveCheckbox = (function() {
    __extends(LiveCheckbox, Backbone.View);
    ...
    LiveCheckbox.prototype.save = function() {
      ...
      return this.model.save({}, {
        success: __bind(function(model, response) {
          return $(this.el).parent().effect("highlight");
        }, this),
        error: __bind(function() {
          $(this.el).parent().addClass("ui-state-error");
  ...
  btb.EditInPlace = (function() {
    __extends(EditInPlace, Backbone.View);
    ...
    EditInPlace.prototype.initialize = function(options) {
      ...
      if (options.commitOnSave !== false) {
        return this.commitOnSave = true;
      }
    };
