...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RemovalReason'
        db.create_table('comments_removalreason', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('default_web_message', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('default_comment_author_message', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('default_post_author_message', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('comments', ['RemovalReason'])

        # Adding M2M table for field organizations on 'RemovalReason'
        db.create_table('comments_removalreason_organizations', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('removalreason', models.ForeignKey(orm['comments.removalreason'], null=False)),
            ('organization', models.ForeignKey(orm['profiles.organization'], null=False))
        ))
        db.create_unique('comments_removalreason_organizations', ['removalreason_id', 'organization_id'])

        # Adding model 'CommentRemoval'
        db.create_table('comments_commentremoval', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('comment', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['comments.Comment'], unique=True)),
            ('reason', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['comments.RemovalReason'], null=True, blank=True)),
            ('web_message', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('comment_author_message', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('post_author_message', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal('comments', ['CommentRemoval'])


    def backwards(self, orm):
        # Deleting model 'RemovalReason'
        db.delete_table('comments_removalreason')

        # Removing M2M table for field organizations on 'RemovalReason'
        db.delete_table('comments_removalreason_organizations')

        # Deleting model 'CommentRemoval'
        db.delete_table('comments_commentremoval')
