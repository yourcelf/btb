...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('comments_comment', (
            ...
            ('comment_doc', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['scanning.Document'], unique=True, null=True, blank=True)),
            ('document', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='comments', null=True, to=orm['scanning.Document'])),
        ...
        db.create_table('comments_favorite', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('comments_favorite')
