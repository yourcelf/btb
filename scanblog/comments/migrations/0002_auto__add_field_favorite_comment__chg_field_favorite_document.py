...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Favorite.comment'
        db.add_column('comments_favorite', 'comment',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['comments.Comment'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Favorite.document'
        db.alter_column('comments_favorite', 'document_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scanning.Document'], null=True))

    def backwards(self, orm):
        # Deleting field 'Favorite.comment'
        db.delete_column('comments_favorite', 'comment_id')


        # User chose to not deal with backwards NULL issues for 'Favorite.document'
        raise RuntimeError("Cannot reverse this migration. 'Favorite.document' and its values cannot be restored.")
